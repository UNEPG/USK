...
#define RADIO_DIO_5_PIN                           GPIO_PIN_12
#endif
...
#define RS485_TRANSCEIVER_SET_AS_TRANSMITTER()  __nop()
#define RS485_TRANSCEIVER_SET_AS_RECEIVER()     __nop()
...
#define GSM_RI_PORT                             GPIOC
//#define GSM_RI_AF                               
#define GSM_RI_GPIO_CLK_ENABLE()                __GPIOC_CLK_ENABLE()
...
#define GPS_PWREN_GPIO_CLK_ENABLE()             __GPIOC_CLK_ENABLE()

#define GPS_1PPS_PIN                            GPIO_PIN_8
#define GPS_1PPS_PORT                           GPIOA
#define GPS_1PPS_GPIO_CLK_ENABLE()              __GPIOA_CLK_ENABLE()

#define GPS_1PPS_LED_PIN                        GPIO_PIN_8
#define GPS_1PPS_LED_PORT                       GPIOB
#define GPS_1PPS_LED_GPIO_CLK_ENABLE()          __GPIOB_CLK_ENABLE()
